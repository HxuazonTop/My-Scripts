-- AudioLogger (only works with synapse)
-- U put ur webhook in audlog page and then click auto log and if someone is not using an antilog it will send the audio to ur webhook

if not syn then game.Players.LocalPlayer:Kick("\n[Audio Logger]\nSorry, only synapse is supported for now.") end
